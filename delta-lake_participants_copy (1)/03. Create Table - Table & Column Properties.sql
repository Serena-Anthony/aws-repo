...
(company_name STRING,
 founded_date DATE,
 country STRING)
coMment 'this tale contains infoabout financial companies'
tblproperties('senstive'='true', 'delta.enableDeletionVector'='false')
...
(company_name STRING NOT NULL,
 ...
 country STRING)
COMMENT 'this table contains info about financial companies'
...
DESCRIBE serio_cat.demo_db.companies;
...
CREATE TABLE serio_cat.demo_db.companies
  (company_id BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1 INCREMENT BY 1),
   ...
   country      STRING)
COMMENT 'This table contains information about some of the finacial companies'   
